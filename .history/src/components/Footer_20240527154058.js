      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-4 col-md-6 mb-4">
            <h3 className="h4 text-white mb-3">SMK TI Bazma</h3>
            <p>
          ...
          <div className="col-lg-4 col-md-6 mb-4">
            ...
            <ul className="list-unstyled">
              <li className="d-inline-flex align-items-center mb-2">
                ...
                Jl. Raya Anyar No.100, Indramayu
              </li>
              <li className="d-inline-flex align-items-center mb-2">
                <i className="bi bi-envelope-fill text-white me-2" />
                sekretariat@smktibazma.sch.id
              </li>
